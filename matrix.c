...
{
	//gen matrix and make it an identity matrix
...
struct matrix * make_rotX(double theta)
{
	...
	//set x and y values to rotated values
	m->m[1][1] = cos(theta * (M_PI / 180));
	m->m[1][2] = -1 * sin(theta * (M_PI / 180));
